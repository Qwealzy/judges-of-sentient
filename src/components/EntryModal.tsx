...
export function EntryModal({ isOpen, isSubmitting, errorMessage, onSubmit }: EntryModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-[#040108]/80 backdrop-blur">
      <div className="flex min-h-full items-center justify-center p-6 md:p-10">
        <div className="relative mx-auto grid w-full max-w-5xl grid-cols-1 gap-10 rounded-[32px] border border-orange-500/30 bg-[#140214]/95 p-8 shadow-[0_0_70px_rgba(255,94,0,0.25)] ring-1 ring-purple-500/20 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] md:p-10">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 -z-10 rounded-[32px] bg-[radial-gradient(circle_at_top,_rgba(255,143,0,0.18),_transparent_60%),radial-gradient(circle_at_bottom,_rgba(147,51,234,0.18),_transparent_55%)]"
          />
          <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
            ...
            <div className="space-y-6">
              ...
              <label className="flex flex-col gap-2" htmlFor={avatarId}>
                <span className="text-xs font-semibold uppercase tracking-[0.45em] text-amber-400/80">Add your profile picture</span>
                <input
                  id={avatarId}
                  name="avatar"
                  type="file"
