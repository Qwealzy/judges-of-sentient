...
function normaliseAssetSrc(asset: ImageAsset) {
        ...
        <div className="flex flex-col items-center gap-10">
          <div className="relative hidden aspect-square w-full max-w-[960px] items-center justify-center md:flex">
            ...
            <div className="relative flex w-[60%] max-w-[620px] flex-col items-start gap-6">
              ...
              <div className="flex w-full flex-col items-center gap-4 text-center">
                <p className="max-w-[420px] text-base font-semibold leading-relaxed text-slate-200">
          ...
          <div className="flex w-full flex-col gap-4 md:hidden">
            ...
            <div className="flex flex-col items-center gap-3 text-center">
              <p className="max-w-[420px] text-sm font-semibold leading-relaxed text-slate-200">
                {dominantResult.description}
              </p>
              {isOwnDominant ? (
                <button
